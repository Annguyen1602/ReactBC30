...
export default class Card extends Component {
  render() {
    ...
    /**
     ...
     + props làm nhiệm vụ nhận giá trị từ nơi sử dụng thẻ (component cha) truyền vào và không được gán lại giá trị(readonly)
     */

    //this.props là thuộc tính có sẳn của component dùng để nhận giá trị từ component cha truyển vào
